...
class FrmIPDAdmission extends JInternalFrame 
{
	...
	Object [][]data;
	JScrollPane jsp;
	String heads[]={"IPD No.","Patient ","Admission Date","Discharge Date","Room No.","Procedure Charges","Dr. Charges","Medical Charges","Other Charges","Total","Advance","Net Bill"};
	JPanel p1;
	JTableHeader header;
	...
	FrmIPDAdmission(JDesktopPane jdp)
	{
		...
		btnDischarge.setForeground(Color.orange);
		btnDischarge.setBackground(new Color(128,0,64));
	    ...
	    jtb.setForeground(new Color(128,0,64));
		...
		jtb.setSelectionBackground(Color.cyan);
    ...
    public Component getTableCellRendererComponent(JTable table,
        ...
        if (!(status.equals("Not Discharged Yet"))) 
        {
