...
public class FrmMainFrame extends JFrame
{
	...
	FrmMainFrame(String user,String type)
	{
		FrmMainFrame.user=user;
		FrmMainFrame.type=type;
		mainframe=this;
		...
		JLabel cpyryt=new JLabel("Copyright 2016, All Rights Reserved | Hospital Management System | Designed & Developed By: Nikhil Gupta, Mukesh Choudhary, Amit Kumar");
		panel_Bottom.add(cpyryt);
	...
	JMenuBar createJMenu()
	{
	   //for File JMenu and its JMenuItems
        ...
        mnuFile.add(jmiChangePassword);
        
        if(type.equals("admin"))
        mnuFile.add(jmiAddUser); 
        /*mnuFile.add(jmiSettings);*/ mnuFile.addSeparator(); mnuFile.add(jmiLogOff); mnuFile.add(jmiExit);
        ...
        jmiPatients.setMnemonic('t');
	   	jmiPatients.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,ActionEvent.CTRL_MASK));
		...
		jmiMedicineCategories=new JMenuItem("Medicine Categories");
		...
		jmiRoomCategories=new JMenuItem("Room Categories");
       ...
       if(type.equals("admin"))
       {
		...
		jmiRoomCharges=new JMenuItem("Room Charges");
	...
	JToolBar createJToolBar()
	{
		...
		btnDoctors.setToolTipText("Doctors");
		...
		btnListofDoctors=new JButton(new ImageIcon(new ImageIcon("images/ListofDoctors.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		btnListofDoctors.setToolTipText("List of Doctors");
		btnListofDoctors.setMargin(ins);
		...
		btnConsultancyCharges=new JButton(new ImageIcon(new ImageIcon("images/ConsultancyCharges.jpg").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT)));
		btnConsultancyCharges.setToolTipText("Room Charges");
		btnConsultancyCharges.setMargin(ins);
		btnConsultancyCharges.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				jdp.add(new FrmRoomCharges());
		...
		btnPrescriptionSlip.setToolTipText("OPD Prescription");
		...
		jtb.add(btnChangePassword);jtb.add(btnLogOff);jtb.add(btnExit);jtb.addSeparator();
		
		if(type.equals("admin"))
		{
		jtb.add(btnDoctors);jtb.add(btnPatients);jtb.add(btnProcedure);jtb.add(btnRoom);jtb.add(btnMedicines);jtb.addSeparator();
		}
		jtb.add(btnListofDoctors);jtb.add(btnConsultancyCharges);jtb.addSeparator();
		if(!(type.equals("doctor")))
		{
