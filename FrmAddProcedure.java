...
class FrmAddProcedure extends JInternalFrame
{
	...
	{	
		...
		lblMedicine.setForeground(new Color(64,0,0));
     	lblMedicine.setFont(new Font(Font.SERIF,Font.ITALIC+Font.BOLD,18));
		
		lblAmount=new JLabel("Amount");
		lblAmount.setForeground(new Color(64,0,0));
